...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-5006078d.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-5006078d.js", assets + "/_app/chunks/vendor-9696d423.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    {
      type: "page",
      pattern: /^\/tv\/review\/vampire-shows\/midnight-mass\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/tv/review/vampire-shows/midnight-mass.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/tv/review/vampire-shows/midnight-mass.svelte": () => Promise.resolve().then(function() {
    return midnightMass;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-90d32474.js", "css": ["assets/pages/__layout.svelte-7bd3e55e.css"], "js": ["pages/__layout.svelte-90d32474.js", "chunks/vendor-9696d423.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-74bbf55f.js", "css": [], "js": ["error.svelte-74bbf55f.js", "chunks/vendor-9696d423.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-7c48eaa9.js", "css": ["assets/pages/index.svelte-b6f83df6.css"], "js": ["pages/index.svelte-7c48eaa9.js", "chunks/vendor-9696d423.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-6a12f742.js", "css": ["assets/pages/tv/review/vampire-shows/midnight-mass.svelte-82a7b479.css"], "js": ["pages/about.svelte-6a12f742.js", "chunks/vendor-9696d423.js", "chunks/env-a13806e5.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-8d2870be.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-8d2870be.js", "chunks/vendor-9696d423.js"], "styles": [] }, "src/routes/tv/review/vampire-shows/midnight-mass.svelte": { "entry": "pages/tv/review/vampire-shows/midnight-mass.svelte-b7130e61.js", "css": ["assets/pages/tv/review/vampire-shows/midnight-mass.svelte-82a7b479.css"], "js": ["pages/tv/review/vampire-shows/midnight-mass.svelte-b7130e61.js", "chunks/vendor-9696d423.js", "chunks/env-a13806e5.js"], "styles": [] } };
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			...
			<li class="${[
    "svelte-t2wq17",
    $page.path === "/tv/review/vampire-shows/midnight-mass" ? "active" : ""
  ].join(" ").trim()}"><a sveltekit:prefetch href="${"/tv/review/vampire-shows/midnight-mass"}" class="${"svelte-t2wq17"}">Midnight Mass Review</a></li>
</ul>
...
<footer class="${"svelte-1izrdc8"}"><p>Camille&#39;s Reviews 2021</p>
</footer>`;
});
...
var router = browser;
var prerender = true;
var Midnight_mass = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Review: Midnight Mass</title>`, ""}`, ""}

<div class="${"content svelte-cf77e8"}"><h1>Midnight Mass (2021)</h1>

	<p>meh.
	</p>
</div>`;
});
var midnightMass = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Midnight_mass,
  hydrate,
  router,
  prerender
});
